                ...
                <div class="col-lg-12">
                   <div class="panel-body">
                            ...
                            <ul class="nav nav-pills">
                                ...
                                <li class="active"><a href="tbddatang.php">Datang</a>
                                </li>
                            </ul>
                                    ...
                                    <div class="col-lg-12">
										<div class="panel panel-primary">
											<div class="panel-heading">
												Tabel Statistik Pendaftaran Penduduk WNI Kota Bandung - Surat Datang
											</div>
										<div class="panel-body" >
										
										<form method="post" name="formstable" id="formstable" action="tbddatang.php" role="form">
...
if (isset($_REQUEST['submit'])) //here give the name of your button on which you would like    //to perform action.
{
	...
	ECHO "<div class='row'>
                <div class='col-lg-12'>
                    <div class='panel panel-default'>
                        <div class='panel-heading'>
                            <i class='fa fa-table fa-fw'></i> TABEL SURAT DATANG MENURUT ALASAN KOTA BANDUNG
                        </div>
                        <!-- /.panel-heading -->
                        <div class='panel-body'>
                            <table width='100%' class='table table-striped table-bordered table-hover' id='dataTables-example'>
                                ...
                                <tbody>";
									...
									FROM SETUP_KEC a INNER JOIN T5_DTG_SURAT_ALASAN b
									...
									echo "<td class='center' align='center'><a target='_blank' href='datang-1/kecamatan/index.php?NOKEC=".htmlentities($row['P1'])."'><i class='fa fa-paw  fa-fw' id=></i> Detail</a></td>";
                                    echo "</tr>";
									}
		...
		ECHO "<div class='row'>
                <div class='col-lg-12'>
                    <div class='panel panel-default'>
                        <div class='panel-heading'>
                            <i class='fa fa-table fa-fw'></i> TABEL SURAT DATANG MENURUT ALASAN KOTA BANDUNG - KECAMATAN ".$row['NAMA_KEC']."
                        </div>
                       <!-- /.panel-heading -->
                        <div class='panel-body'>
                            <table width='100%' class='table table-striped table-bordered table-hover' id='dataTables-example'>
                                ...
                                <tbody>";
									...
									FROM SETUP_KEL a INNER JOIN T5_DTG_SURAT_ALASAN b
                                    ...
                                    echo "<td class='center'>".htmlentities($row['P9'])."</td>";
                                    echo "<td class='center'>".htmlentities($row['P10'])."</td>";
									echo "<td class='center' align='center'><a target='_blank' href='datang-1/kecamatan/kelurahan/index.php?NOKEL=".htmlentities($row['P1'])."'><i class='fa fa-paw  fa-fw' id=></i> Detail</a></td>";
                                    echo "</tr>";
									}
		...
		ECHO "<div class='row'>
                <div class='col-lg-12'>
                    <div class='panel panel-default'>
                        <div class='panel-heading'>
                            <i class='fa fa-table fa-fw'></i> TABEL SURAT DATANG MENURUT ALASAN KOTA BANDUNG - KELURAHAN ".$row['NAMA_KEL']."
                        </div>
                       <!-- /.panel-heading -->
                        <div class='panel-body'>
                            <table width='100%' class='table table-striped table-bordered table-hover' id='dataTables-example'>
	...
	ECHO "<div class='row'>
                <div class='col-lg-12'>
                    <div class='panel panel-default'>
                        <div class='panel-heading'>
                            <i class='fa fa-table fa-fw'></i> TABEL SURAT DATANG MENURUT KLASIFIKASI KEPINDAHAN KOTA BANDUNG
                        </div>
                        <!-- /.panel-heading -->
                        <div class='panel-body'>
                            <table width='100%' class='table table-striped table-bordered table-hover' id='dataTables-example'>
                                ...
                                <tbody>";
									...
									FROM SETUP_KEC a INNER JOIN T5_DTG_SURAT_KLASIFIKASI b
									ON a.NO_KEC=b.NO_KEC WHERE a.NO_PROP='32' AND a.NO_KAB ='73' and b.BLN  >= TO_DATE('".$BULAN."','MM/yyyy') AND b.BLN < TO_DATE('".$BULAN."','MM/yyyy')+1
									GROUP BY a.NO_KEC, a.NAMA_KEC ORDER BY a.NO_KEC";
									$stmt = oci_parse($conn, $sql);
									oci_execute($stmt);
                                    ...
                                    echo "<td class='center'>".htmlentities($row['P7'])."</td>";
									echo "<td class='center' align='center'><a target='_blank' href='datang-2/kecamatan/index.php?NOKEC=".htmlentities($row['P1'])."'><i class='fa fa-paw  fa-fw' id=></i> Detail</a></td>";
                                    echo "</tr>";
									}
		...
		ECHO "<div class='row'>
                <div class='col-lg-12'>
                    <div class='panel panel-default'>
                        <div class='panel-heading'>
                            <i class='fa fa-table fa-fw'></i> TABEL SURAT DATANG MENURUT KLASIFIKASI KEPINDAHAN KOTA BANDUNG - KECAMATAN ".$row['NAMA_KEC']."
                        </div>
                        <!-- /.panel-heading -->
                        <div class='panel-body'>
                            <table width='100%' class='table table-striped table-bordered table-hover' id='dataTables-example'>
                                ...
                                <tbody>";
									...
									FROM SETUP_KEL a INNER JOIN T5_DTG_SURAT_KLASIFIKASI b
									ON a.NO_KEC=b.NO_KEC and a.NO_KEL=b.NO_KEL  WHERE a.NO_PROP='32' AND a.NO_KAB ='73' AND a.NO_KEC ='".$NOKEC."' and b.BLN  >= TO_DATE('".$BULAN."','MM/yyyy') AND b.BLN < TO_DATE('".$BULAN."','MM/yyyy')+1
									GROUP BY a.NO_KEC, a.NO_KEL, a.NAMA_KEL ORDER BY a.NO_KEL";
									$stmt = oci_parse($conn, $sql);
									oci_execute($stmt);
		...
		ECHO "<div class='row'>
                <div class='col-lg-12'>
                    <div class='panel panel-default'>
                        <div class='panel-heading'>
                            <i class='fa fa-table fa-fw'></i> TABEL SURAT DATANG MENURUT KLASIFIKASI KEPINDAHAN KOTA BANDUNG - KELURAHAN ".$row['NAMA_KEL']."
                        </div>
                        <!-- /.panel-heading -->
                        <div class='panel-body'>
                            <table width='100%' class='table table-striped table-bordered table-hover' id='dataTables-example'>
	...
	ECHO "<div class='row'>
                <div class='col-lg-12'>
                    <div class='panel panel-default'>
                        <div class='panel-heading'>
                            <i class='fa fa-table fa-fw'></i> TABEL SURAT DATANG MENURUT JENIS PINDAH KOTA BANDUNG
                        </div>
                        <!-- /.panel-heading -->
                        <div class='panel-body'>
                            <table width='100%' class='table table-striped table-bordered table-hover' id='dataTables-example'>
                                ...
                                <tbody>";
									...
									$sql= "SELECT a.NO_KEC as P1, a.NAMA_KEC AS P2,SUM(b.NUMPANG_KK) AS P3, SUM(b.MEMBUAT_KK) AS P4, SUM(b.KK_TETAP) AS P5, SUM(b.NUMPANG_KK)+ SUM(b.MEMBUAT_KK) + SUM(b.KK_TETAP)  AS P6
									FROM SETUP_KEC a INNER JOIN T5_DTG_SURAT_JENIS_DATANG b
									ON a.NO_KEC=b.NO_KEC WHERE a.NO_PROP='32' AND a.NO_KAB ='73' and b.BLN  >= TO_DATE('".$BULAN."','MM/yyyy') AND b.BLN < TO_DATE('".$BULAN."','MM/yyyy')+1
									GROUP BY a.NO_KEC, a.NAMA_KEC ORDER BY a.NO_KEC";
									$stmt = oci_parse($conn, $sql);
									oci_execute($stmt);
                                    ...
                                    echo "<td class='center'>".htmlentities($row['P5'])."</td>";
									echo "<td class='center'>".htmlentities($row['P6'])."</td>";
                                    echo "<td class='center' align='center'><a target='_blank' href='datang-3/kecamatan/index.php?NOKEC=".htmlentities($row['P1'])."'><i class='fa fa-paw  fa-fw' id=></i> Detail</a></td>";
                                    echo "</tr>";
		...
		ECHO "<div class='row'>
                <div class='col-lg-12'>
                    <div class='panel panel-default'>
                        <div class='panel-heading'>
                            <i class='fa fa-table fa-fw'></i> TABEL SURAT DATANG MENURUT JENIS PINDAH KOTA BANDUNG - KECAMATAN ".$row['NAMA_KEC']."
                        </div>
                        <!-- /.panel-heading -->
                        <div class='panel-body'>
                            <table width='100%' class='table table-striped table-bordered table-hover' id='dataTables-example'>
                                ...
                                <tbody>";
									...
									FROM SETUP_KEL a INNER JOIN T5_DTG_SURAT_JENIS_DATANG b
									ON a.NO_KEC=b.NO_KEC and a.NO_KEL=b.NO_KEL  WHERE a.NO_PROP='32' AND a.NO_KAB ='73' AND a.NO_KEC ='".$NOKEC."' and b.BLN  >= TO_DATE('".$BULAN."','MM/yyyy') AND b.BLN < TO_DATE('".$BULAN."','MM/yyyy')+1
									GROUP BY a.NO_KEC, a.NO_KEL, a.NAMA_KEL ORDER BY a.NO_KEL";
									$stmt = oci_parse($conn, $sql);
									oci_execute($stmt);
                                    ...
                                    echo "<td class='center'>".htmlentities($row['P5'])."</td>";
									echo "<td class='center'>".htmlentities($row['P6'])."</td>";
									echo "<td class='center' align='center'><a target='_blank' href='datang-3/kecamatan/kelurahan/index.php?NOKEL=".htmlentities($row['P1'])."'><i class='fa fa-paw  fa-fw' id=></i> Detail</a></td>";
                                    echo "</tr>";
									}
		...
		ECHO "<div class='row'>
                <div class='col-lg-12'>
                    <div class='panel panel-default'>
                        <div class='panel-heading'>
                            <i class='fa fa-table fa-fw'></i> TABEL SURAT DATANG MENURUT JENIS PINDAH KOTA BANDUNG - KELURAHAN ".$row['NAMA_KEL']."
                        </div>
                        <!-- /.panel-heading -->
                        <div class='panel-body'>
                            <table width='100%' class='table table-striped table-bordered table-hover' id='dataTables-example'>
...
//STATISTIK 4
	...
	ECHO "<div class='row'>
                <div class='col-lg-12'>
                    <div class='panel panel-default'>
                        <div class='panel-heading'>
                            <i class='fa fa-table fa-fw'></i> TABEL ANGGOTA DATANG MENURUT ALASAN KOTA BANDUNG
                        </div>
                        <!-- /.panel-heading -->
                        <div class='panel-body'>
                            <table width='100%' class='table table-striped table-bordered table-hover' id='dataTables-example'>
                                ...
                                <tbody>";
									...
									$sql= "SELECT a.NO_KEC as P1, a.NAMA_KEC AS P2, SUM(b.PEKERJAAN) AS P3, SUM(b.PENDIDIKAN) AS P4, SUM(b.KEAMANAN) AS P5,SUM(b.KESEHATAN) AS P6, SUM(b.PERUMAHAN) AS P7, SUM(b.KELUARGA) AS P8,SUM(b.LAIN_LAIN) AS P9, SUM(b.PEKERJAAN) +SUM(b.PENDIDIKAN) + SUM(b.KEAMANAN) +SUM(b.KESEHATAN) + SUM(b.PERUMAHAN) +SUM(b.KELUARGA) +SUM(b.LAIN_LAIN) AS P10
									FROM SETUP_KEC a INNER JOIN T5_DTG_ANGGOTA_ALASAN b
									ON a.NO_KEC=b.NO_KEC WHERE a.NO_PROP='32' AND a.NO_KAB ='73' and b.BLN  >= TO_DATE('".$BULAN."','MM/yyyy') AND b.BLN < TO_DATE('".$BULAN."','MM/yyyy')+1
									GROUP BY a.NO_KEC, a.NAMA_KEC ORDER BY a.NO_KEC";
									$stmt = oci_parse($conn, $sql);
									oci_execute($stmt);
                                    ...
                                    echo "<td class='center'>".htmlentities($row['P9'])."</td>";
                                    echo "<td class='center'>".htmlentities($row['P10'])."</td>";
									echo "<td class='center' align='center'><a target='_blank' href='datang-4/kecamatan/index.php?NOKEC=".htmlentities($row['P1'])."'><i class='fa fa-paw  fa-fw' id=></i> Detail</a></td>";
                                    echo "</tr>";
									}
		...
		ECHO "<div class='row'>
                <div class='col-lg-12'>
                    <div class='panel panel-default'>
                        <div class='panel-heading'>
                            <i class='fa fa-table fa-fw'></i> TABEL ANGGOTA DATANG MENURUT ALASAN KOTA BANDUNG - KECAMATAN ".$row['NAMA_KEC']."
                        </div>
                       <!-- /.panel-heading -->
                        <div class='panel-body'>
                            <table width='100%' class='table table-striped table-bordered table-hover' id='dataTables-example'>
                                ...
                                <tbody>";
									...
									$sql= "SELECT a.NO_KEC as P99, a.NO_KEL as P1, a.NAMA_KEL AS P2, SUM(b.PEKERJAAN) AS P3, SUM(b.PENDIDIKAN) AS P4, SUM(b.KEAMANAN) AS P5,SUM(b.KESEHATAN) AS P6, SUM(b.PERUMAHAN) AS P7, SUM(b.KELUARGA) AS P8,SUM(b.LAIN_LAIN) AS P9, SUM(b.PEKERJAAN) +SUM(b.PENDIDIKAN) + SUM(b.KEAMANAN) +SUM(b.KESEHATAN) + SUM(b.PERUMAHAN) +SUM(b.KELUARGA) +SUM(b.LAIN_LAIN) AS P10
									FROM SETUP_KEL a INNER JOIN T5_DTG_ANGGOTA_ALASAN b
									ON a.NO_KEC=b.NO_KEC and a.NO_KEL=b.NO_KEL  WHERE a.NO_PROP='32' AND a.NO_KAB ='73' AND a.NO_KEC ='".$NOKEC."' and b.BLN  >= TO_DATE('".$BULAN."','MM/yyyy') AND b.BLN < TO_DATE('".$BULAN."','MM/yyyy')+1
									GROUP BY a.NO_KEC, a.NO_KEL, a.NAMA_KEL ORDER BY a.NO_KEL";
									$stmt = oci_parse($conn, $sql);
									oci_execute($stmt);
                                    ...
                                    echo "<td class='center'>".htmlentities($row['P9'])."</td>";
                                    echo "<td class='center'>".htmlentities($row['P10'])."</td>";
									echo "<td class='center' align='center'><a target='_blank' href='datang-4/kecamatan/kelurahan/index.php?NOKEL=".htmlentities($row['P1'])."'><i class='fa fa-paw  fa-fw' id=></i> Detail</a></td>";
                                    echo "</tr>";
									}
		...
		ECHO "<div class='row'>
                <div class='col-lg-12'>
                    <div class='panel panel-default'>
                        <div class='panel-heading'>
                            <i class='fa fa-table fa-fw'></i> TABEL ANGGOTA DATANG MENURUT ALASAN KOTA BANDUNG - KELURAHAN ".$row['NAMA_KEL']."
                        </div>
                       <!-- /.panel-heading -->
                        <div class='panel-body'>
                            <table width='100%' class='table table-striped table-bordered table-hover' id='dataTables-example'>
	...
	ECHO "<div class='row'>
                <div class='col-lg-12'>
                    <div class='panel panel-default'>
                        <div class='panel-heading'>
                            <i class='fa fa-table fa-fw'></i> TABEL ANGGOTA DATANG MENURUT KLASIFIKASI KEPINDAHAN KOTA BANDUNG
                        </div>
                        <!-- /.panel-heading -->
                        <div class='panel-body'>
                            <table width='100%' class='table table-striped table-bordered table-hover' id='dataTables-example'>
                                ...
                                <tbody>";
									...
									$sql= "SELECT a.NO_KEC as P1, a.NAMA_KEC AS P2,SUM(b.ANTAR_DESA) AS P3, SUM(b.ANTAR_KEC) AS P4, SUM(b.ANTAR_KAB) AS P5, SUM(b.ANTAR_PROV) AS P6, SUM(b.ANTAR_DESA)+ SUM(b.ANTAR_KEC) + SUM(b.ANTAR_KAB) + SUM(b.ANTAR_PROV) AS P7
									FROM SETUP_KEC a INNER JOIN T5_DTG_ANGGOTA_KLASIFIKASI b
									ON a.NO_KEC=b.NO_KEC WHERE a.NO_PROP='32' AND a.NO_KAB ='73' and b.BLN  >= TO_DATE('".$BULAN."','MM/yyyy') AND b.BLN < TO_DATE('".$BULAN."','MM/yyyy')+1
									GROUP BY a.NO_KEC, a.NAMA_KEC ORDER BY a.NO_KEC";
									$stmt = oci_parse($conn, $sql);
									oci_execute($stmt);
									...
									echo "<td class='center'>".htmlentities($row['P6'])."</td>";
                                    echo "<td class='center'>".htmlentities($row['P7'])."</td>";
									echo "<td class='center' align='center'><a target='_blank' href='datang-5/kecamatan/index.php?NOKEC=".htmlentities($row['P1'])."'><i class='fa fa-paw  fa-fw' id=></i> Detail</a></td>";
                                    echo "</tr>";
									}
		...
		ECHO "<div class='row'>
                <div class='col-lg-12'>
                    <div class='panel panel-default'>
                        <div class='panel-heading'>
                            <i class='fa fa-table fa-fw'></i> TABEL ANGGOTA DATANG MENURUT KLASIFIKASI KEPINDAHAN KOTA BANDUNG - KECAMATAN ".$row['NAMA_KEC']."
                        </div>
                        <!-- /.panel-heading -->
                        <div class='panel-body'>
                            <table width='100%' class='table table-striped table-bordered table-hover' id='dataTables-example'>
                                ...
                                <tbody>";
									...
									$sql= "SELECT a.NO_KEC as P99, a.NO_KEL as P1, a.NAMA_KEL AS P2, SUM(b.ANTAR_DESA) AS P3, SUM(b.ANTAR_KEC) AS P4, SUM(b.ANTAR_KAB) AS P5, SUM(b.ANTAR_PROV) AS P6, SUM(b.ANTAR_DESA)+ SUM(b.ANTAR_KEC) + SUM(b.ANTAR_KAB) + SUM(b.ANTAR_PROV) AS P7
									FROM SETUP_KEL a INNER JOIN T5_DTG_ANGGOTA_KLASIFIKASI b
									ON a.NO_KEC=b.NO_KEC and a.NO_KEL=b.NO_KEL  WHERE a.NO_PROP='32' AND a.NO_KAB ='73' AND a.NO_KEC ='".$NOKEC."' and b.BLN  >= TO_DATE('".$BULAN."','MM/yyyy') AND b.BLN < TO_DATE('".$BULAN."','MM/yyyy')+1
									GROUP BY a.NO_KEC, a.NO_KEL, a.NAMA_KEL ORDER BY a.NO_KEL";
									$stmt = oci_parse($conn, $sql);
									oci_execute($stmt);
		...
		ECHO "<div class='row'>
                <div class='col-lg-12'>
                    <div class='panel panel-default'>
                        <div class='panel-heading'>
                            <i class='fa fa-table fa-fw'></i> TABEL ANGGOTA DATANG MENURUT KLASIFIKASI KEPINDAHAN KOTA BANDUNG - KELURAHAN ".$row['NAMA_KEL']."
                        </div>
                        <!-- /.panel-heading -->
                        <div class='panel-body'>
                            <table width='100%' class='table table-striped table-bordered table-hover' id='dataTables-example'>
	...
	ECHO "<div class='row'>
                <div class='col-lg-12'>
                    <div class='panel panel-default'>
                        <div class='panel-heading'>
                            <i class='fa fa-table fa-fw'></i> TABEL ANGGOTA DATANG MENURUT JENIS PINDAH KOTA BANDUNG
                        </div>
                        <!-- /.panel-heading -->
                        <div class='panel-body'>
                            <table width='100%' class='table table-striped table-bordered table-hover' id='dataTables-example'>
                                ...
                                <tbody>";
									...
									$sql= "SELECT a.NO_KEC as P1, a.NAMA_KEC AS P2,SUM(b.NUMPANG_KK) AS P3, SUM(b.MEMBUAT_KK) AS P4, SUM(b.KK_TETAP) AS P5, SUM(b.NUMPANG_KK)+ SUM(b.MEMBUAT_KK) + SUM(b.KK_TETAP)  AS P6
									FROM SETUP_KEC a INNER JOIN T5_DTG_ANGGOTA_JENIS_DATANG b
									ON a.NO_KEC=b.NO_KEC WHERE a.NO_PROP='32' AND a.NO_KAB ='73' and b.BLN  >= TO_DATE('".$BULAN."','MM/yyyy') AND b.BLN < TO_DATE('".$BULAN."','MM/yyyy')+1
									GROUP BY a.NO_KEC, a.NAMA_KEC ORDER BY a.NO_KEC";
									$stmt = oci_parse($conn, $sql);
									oci_execute($stmt);
                                    ...
                                    echo "<td class='center'>".htmlentities($row['P5'])."</td>";
									echo "<td class='center'>".htmlentities($row['P6'])."</td>";
                                    echo "<td class='center' align='center'><a target='_blank' href='datang-6/kecamatan/index.php?NOKEC=".htmlentities($row['P1'])."'><i class='fa fa-paw  fa-fw' id=></i> Detail</a></td>";
                                    echo "</tr>";
		...
		ECHO "<div class='row'>
                <div class='col-lg-12'>
                    <div class='panel panel-default'>
                        <div class='panel-heading'>
                            <i class='fa fa-table fa-fw'></i> TABEL ANGGOTA DATANG MENURUT JENIS PINDAH KOTA BANDUNG - KECAMATAN ".$row['NAMA_KEC']."
                        </div>
                        <!-- /.panel-heading -->
                        <div class='panel-body'>
                            <table width='100%' class='table table-striped table-bordered table-hover' id='dataTables-example'>
                                ...
                                <tbody>";
                                    ...
                                    echo "<td class='center'>".htmlentities($row['P5'])."</td>";
									echo "<td class='center'>".htmlentities($row['P6'])."</td>";
									echo "<td class='center' align='center'><a target='_blank' href='datang-6/kecamatan/kelurahan/index.php?NOKEL=".htmlentities($row['P1'])."'><i class='fa fa-paw  fa-fw' id=></i> Detail</a></td>";
                                    echo "</tr>";
									}
		...
		ECHO "<div class='row'>
                <div class='col-lg-12'>
                    <div class='panel panel-default'>
                        <div class='panel-heading'>
                            <i class='fa fa-table fa-fw'></i> TABEL ANGGOTA DATANG MENURUT JENIS PINDAH KOTA BANDUNG - KELURAHAN ".$row['NAMA_KEL']."
                        </div>
                        <!-- /.panel-heading -->
                        <div class='panel-body'>
                            <table width='100%' class='table table-striped table-bordered table-hover' id='dataTables-example'>
	...
	ECHO "<div class='row'>
                <div class='col-lg-12'>
                    <div class='panel panel-default'>
                        <div class='panel-heading'>
                            <i class='fa fa-table fa-fw'></i> TABEL ANGGOTA DATANG MENURUT JENIS KELAMIN KOTA BANDUNG
                        </div>
                        <!-- /.panel-heading -->
                        <div class='panel-body'>
                            <table width='100%' class='table table-striped table-bordered table-hover' id='dataTables-example'>
                                ...
                                <tbody>";
									...
									FROM SETUP_KEC a INNER JOIN T5_DTG_ANGGOTA_KELAMIN b
									ON a.NO_KEC=b.NO_KEC WHERE a.NO_PROP='32' AND a.NO_KAB ='73' and b.BLN  >= TO_DATE('".$BULAN."','MM/yyyy') AND b.BLN < TO_DATE('".$BULAN."','MM/yyyy')+1
									GROUP BY a.NO_KEC, a.NAMA_KEC ORDER BY a.NO_KEC";
									$stmt = oci_parse($conn, $sql);
									oci_execute($stmt);
                                    ...
                                    echo "<td class='center'>".htmlentities($row['P4'])."</td>";
                                    echo "<td class='center'>".htmlentities($row['P5'])."</td>";
									echo "<td class='center' align='center'><a target='_blank' href='datang-7/kecamatan/index.php?NOKEC=".htmlentities($row['P1'])."'><i class='fa fa-paw  fa-fw' id=></i> Detail</a></td>";
                                    echo "</tr>";
									}
		...
		ECHO "<div class='row'>
                <div class='col-lg-12'>
                    <div class='panel panel-default'>
                        <div class='panel-heading'>
                            <i class='fa fa-table fa-fw'></i> TABEL ANGGOTA DATANG MENURUT JENIS KELAMIN KOTA BANDUNG - KECAMATAN ".$row['NAMA_KEC']."
                        </div>
                       <!-- /.panel-heading -->
                        <div class='panel-body'>
                            <table width='100%' class='table table-striped table-bordered table-hover' id='dataTables-example'>
                                ...
                                <tbody>";
									...
									FROM SETUP_KEL a INNER JOIN T5_DTG_ANGGOTA_KELAMIN b
									ON a.NO_KEC=b.NO_KEC and a.NO_KEL=b.NO_KEL  WHERE a.NO_PROP='32' AND a.NO_KAB ='73' AND a.NO_KEC ='".$NOKEC."' and b.BLN  >= TO_DATE('".$BULAN."','MM/yyyy') AND b.BLN < TO_DATE('".$BULAN."','MM/yyyy')+1
									GROUP BY a.NO_KEC, a.NO_KEL, a.NAMA_KEL ORDER BY a.NO_KEL";
									$stmt = oci_parse($conn, $sql);
									oci_execute($stmt);
		...
		ECHO "<div class='row'>
                <div class='col-lg-12'>
                    <div class='panel panel-default'>
                        <div class='panel-heading'>
                            <i class='fa fa-table fa-fw'></i> TABEL ANGGOTA DATANG MENURUT JENIS KELAMIN KOTA BANDUNG - KELURAHAN ".$row['NAMA_KEL']."
                        </div>
                       <!-- /.panel-heading -->
                        <div class='panel-body'>
                            <table width='100%' class='table table-striped table-bordered table-hover' id='dataTables-example'>
