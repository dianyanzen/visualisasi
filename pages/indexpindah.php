...
<!-- Navigation -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Daftar Enti Pindah Keluar<br>
					<?php
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-table fa-fw"></i> Surat Pindah
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
									...
									$nowdate = date("d/m/Y");
									$sql= "SELECT PINDAH_HEADER.NO_KK, PINDAH_HEADER.NAMA_KEP_KEL, A5_MASTER_KLAS_PINDAH.DESCRIP, PINDAH_HEADER.CREATED_DATE, PINDAH_HEADER.CREATED_BY FROM PINDAH_HEADER INNER JOIN A5_MASTER_KLAS_PINDAH ON PINDAH_HEADER.KLASIFIKASI_PINDAH = A5_MASTER_KLAS_PINDAH.NO WHERE CREATED_DATE >= TO_DATE('".$nowdate."','dd/MM/yyyy') AND CREATED_DATE < TO_DATE('".$nowdate."','dd/MM/yyyy') +1";
									$stmt = oci_parse($conn, $sql);
									oci_execute($stmt);
									while (($row = oci_fetch_array($stmt, OCI_ASSOC)) != false) {
                                    echo "<tr class='gradeA'>";
                                    echo "<td>".htmlentities($row['NO_KK'])."</td>";
                                    echo "<td>".htmlentities($row['NAMA_KEP_KEL'])."</td>";
                                    echo "<td>".htmlentities($row['DESCRIP'])."</td>";
                                    echo "<td class='center'>".htmlentities($row['CREATED_BY'])."</td>";
                                    echo "<td class='center'>".htmlentities($row['CREATED_DATE'])."</td>";
                                    echo "</tr>";
									}
									?>
								</tbody>
