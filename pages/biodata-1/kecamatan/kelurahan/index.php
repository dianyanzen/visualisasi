        ...
        <div id="page-wrapper">
            <div class="row">
				...
				Include('../../../../config/connect222.php');
					...
					//echo "text: 'DIAGRAM KOLOM BIODATA MENURUT GOLONGAN DARAH KECAMATAN ".$row['NAMA_KEL']."'";
					
                    ECHO "<h1 class='page-header'>DATA BIODATA KELURAHAN ".$row['NAMA_KEL']."<br>";
					?>
					<?php
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <i class="fa fa-table fa-fw"></i> Biodata Menurut Jenis Kelamin
                        </div>
                        <!-- /.panel-heading -->
