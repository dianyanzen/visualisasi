        ...
        <div id="page-wrapper">
            <div class="row">
				...
				Include('../../../config/connect222.php');
                    ...
                    ECHO "<h1 class='page-header'>DATA BIODATA KECAMATAN ".$row['NAMA_KEC']."<br>";
					?>
					<?php
                        ...
                        <div class="panel-body">
                            <table width='100%' class='table table-striped table-bordered table-hover' id='dataTables-example'>
                                ...
                                <tbody>
									...
									echo "<td class='center'><a href='../../biodata-1/kecamatan/kelurahan/index.php?NOKEL=".htmlentities($row['P1'])."'><i class='fa fa-paw  fa-fw'></i> Detail</a></td>";
                                    echo "</tr>";
									}
