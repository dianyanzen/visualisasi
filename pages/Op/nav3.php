        ...
        <div class="navbar-header">
          ...
          <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
			  ...
			  <li><a href="indexreport.php?user=<?php echo htmlentities($_GET['user']) ?>"><i class="fa fa-reddit-square fa-fw"></i> Keluhan</a></li>
			  <li class="active"><a href="indexmanager.php?user=<?php echo htmlentities($_GET['user']) ?>"><i class="fa fa-folder-open  fa-fw"></i> File Manager</a></li>
