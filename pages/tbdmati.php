                ...
                <div class="col-lg-12">
                   <div class="panel-body">
                            ...
                            <ul class="nav nav-pills">
                                ...
                                <li class="active"><a href="tbdmati.php">Kematian</a>
                                </li>
                                    ...
                                    <div class="col-lg-12">
										<div class="panel panel-primary">
											<div class="panel-heading">
												Tabel Statistik Pendaftaran Penduduk WNI Kota Bandung - Akta Kematian
											</div>
										<div class="panel-body" >
										
										<form method="post" name="formstable" id="formstable" action="tbdmati.php" role="form">
	...
	ECHO "<div class='row'>
                <div class='col-lg-12'>
                    <div class='panel panel-default'>
                        <div class='panel-heading'>
                            <i class='fa fa-table fa-fw'></i> TABEL KEMATIAN MENURUT JENIS KELAMIN KOTA BANDUNG
                        </div>
                        <!-- /.panel-heading -->
                        <div class='panel-body'>
                            <table width='100%' class='table table-striped table-bordered table-hover' id='dataTables-example'>
                                ...
                                <tbody>";
									...
									$sql= "SELECT SUM(LK) as P1, SUM(LP) as P2, SUM(LK)+SUM(LP) AS P3 FROM T5_KMT_JENIS_KELAMIN WHERE NO_PROP='32' AND NO_KAB ='73' and BLN  >= TO_DATE('".$BULAN."','MM/yyyy') AND BLN < TO_DATE('".$BULAN."','MM/yyyy')+1";
									$stmt = oci_parse($conn, $sql);
									oci_execute($stmt);
									while (($row = oci_fetch_array($stmt,OCI_ASSOC)) != false) {
...
if($_REQUEST['statistik']=="2"){
	...
	ECHO "<div class='row'>
                <div class='col-lg-12'>
                    <div class='panel panel-default'>
                        <div class='panel-heading'>
                            <i class='fa fa-table fa-fw'></i> TABEL KEMATIAN MENURUT AGAMA KOTA BANDUNG
                        </div>
                        <!-- /.panel-heading -->
                        <div class='panel-body'>
                            <table width='100%' class='table table-striped table-bordered table-hover' id='dataTables-example'>
                                ...
                                <tbody>";
									...
									$sql= "SELECT SUM(ISLAM) AS P1, SUM(KRISTEN) AS P2,SUM(KATHOLIK) AS P3,SUM(HINDU) AS P4,SUM(BUDHA) AS P5,SUM(KONGHUCU) AS P6,SUM(KEPERCAYAAN) AS P7,SUM(ISLAM)+SUM(KRISTEN)+SUM(KATHOLIK)+SUM(HINDU)+SUM(BUDHA)+SUM(KONGHUCU)+SUM(KEPERCAYAAN) AS P8 FROM T5_KMT_AGAMA WHERE NO_PROP='32' AND NO_KAB ='73' and BLN  >= TO_DATE('".$BULAN."','MM/yyyy') AND BLN < TO_DATE('".$BULAN."','MM/yyyy')+1";
									$stmt = oci_parse($conn, $sql);
									oci_execute($stmt);
									while (($row = oci_fetch_array($stmt,OCI_ASSOC)) != false) {
                                    echo "<tr class='gradeA'>";
	...
	ECHO "<div class='row'>
                <div class='col-lg-12'>
                    <div class='panel panel-default'>
                        <div class='panel-heading'>
                            <i class='fa fa-table fa-fw'></i> TABEL KEMATIAN MENURUT PENYEBAB KEMATIAN KOTA BANDUNG
                        </div>
                        <!-- /.panel-heading -->
                        <div class='panel-body'>
                            <table width='100%' class='table table-striped table-bordered table-hover' id='dataTables-example'>
                                ...
                                <tbody>";
									...
									$sql= "SELECT SUM(SAKIT) AS P1, SUM(PENDEMI) AS P2,SUM(KECELAKAAN) AS P3,SUM(KRIMINAL) AS P4,SUM(BUNUH_DIRI) AS P5, SUM(LAINNYA) AS P6,SUM(SAKIT)+SUM(PENDEMI)+SUM(KECELAKAAN)+SUM(KRIMINAL)+SUM(BUNUH_DIRI)+SUM(LAINNYA) AS P7 FROM T5_KMT_SEBAB WHERE NO_PROP='32' AND NO_KAB ='73' and BLN  >= TO_DATE('".$BULAN."','MM/yyyy') AND BLN < TO_DATE('".$BULAN."','MM/yyyy')+1";
									$stmt = oci_parse($conn, $sql);
									oci_execute($stmt);
									while (($row = oci_fetch_array($stmt,OCI_ASSOC)) != false) {
                                    echo "<tr class='gradeA'>";
...
//TABEL 4
	...
	ECHO "<div class='row'>
                <div class='col-lg-12'>
                    <div class='panel panel-default'>
                        <div class='panel-heading'>
                            <i class='fa fa-table fa-fw'></i> TABEL KEMATIAN MENURUT YANG MENERANGKAN KOTA BANDUNG
                        </div>
                        <!-- /.panel-heading -->
                        <div class='panel-body'>
                            <table width='100%' class='table table-striped table-bordered table-hover' id='dataTables-example'>
                                ...
                                <tbody>";
									...
									$sql= "SELECT SUM(DOKTER) AS P1, SUM(TENAGA_KESEHATAN) AS P2,SUM(KEPOLISIAN) AS P3,SUM(LAINNYA) AS P4,SUM(DOKTER)+SUM(TENAGA_KESEHATAN)+SUM(KEPOLISIAN)+SUM(LAINNYA) AS P5 FROM T5_KMT_MENERANGKAN WHERE NO_PROP='32' AND NO_KAB ='73' and BLN  >= TO_DATE('".$BULAN."','MM/yyyy') AND BLN < TO_DATE('".$BULAN."','MM/yyyy')+1";
									$stmt = oci_parse($conn, $sql);
									oci_execute($stmt);
									while (($row = oci_fetch_array($stmt,OCI_ASSOC)) != false) {
                                    echo "<tr class='gradeA'>";
