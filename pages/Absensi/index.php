		...
		<?PHP		
					...
					if($count == 0){ ?>
                        ...
                        <div class="panel-heading">
                            <i class="fa fa-desktop fa-fw"></i> Absensi Admin
                        </div>
                        <!-- /.panel-heading -->
        ...
        <div id="page-wrapper">
            <div class="row">
				...
				Include('../../config/connect223.php');
                    ...
                    ECHO "<h1 class='page-header'>FORM ABSENSI ADMIN ".$row['NAMA_LGKP']."<br>";
            ...
            <div class="row">
				...
				<div class="col-lg-6 col-md-6">
                        ...
                        <div class="panel-body">
						<div class="row">
					<form id="formstatus" action="statusindex.php?user=<?php echo htmlentities($_GET['user']) ?>" method="post">
