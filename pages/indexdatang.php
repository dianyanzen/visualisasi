...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Daftar Entri Pindah Datang<br>
					<?php
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-table fa-fw"></i> Surat Datang
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
									...
									$nowdate = date("d/m/Y");
									$sql= "SELECT DATANG_HEADER.NO_KK, DATANG_HEADER.NAMA_KEP, A5_MASTER_KLAS_PINDAH.DESCRIP, DATANG_HEADER.CREATED_DATE, DATANG_HEADER.CREATED_BY FROM DATANG_HEADER INNER JOIN A5_MASTER_KLAS_PINDAH ON DATANG_HEADER.KLASIFIKASI_PINDAH = A5_MASTER_KLAS_PINDAH.NO WHERE CREATED_DATE >= TO_DATE('".$nowdate."','dd/MM/yyyy') AND CREATED_DATE < TO_DATE('".$nowdate."','dd/MM/yyyy') +1";
