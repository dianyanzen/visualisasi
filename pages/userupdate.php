                ...
                <div class="col-lg-12">
                   <div class="panel-body">
                            ...
                            <ul class="nav nav-pills">
								...
								<li><h1> System Disduk Update User</h1></li>
                            </ul>
                            ...
                            <div class="tab-content">
								...
								<br>
                                    <div class="col-lg-12">
										<div class="panel panel-primary">
											<div class="panel-heading">
												Sistem Information Administrator - Update User
											</div>
										<div class="panel-body" >
										
										<form method="post" name="formstatistik" id="formstatistik" action="userupdate.php" role="form">
										...
										<div class="row">
											...
											<?php Include('../config/connectlogin.php');?>
											<?php $sql= "select USERNAME, NAMA from USER_ID WHERE GRUP_ID NOT LIKE '1' ORDER BY GRUP_ID";
												$stmt = oci_parse($conn, $sql);
												oci_execute($stmt);
												while (($row = oci_fetch_array($stmt,OCI_ASSOC)) != false) {
                                               	ECHO "<option value='".htmlentities($row['USERNAME'])."'>".htmlentities($row['USERNAME'])." (".htmlentities($row['NAMA']).")</option>";
												};
												?>
                                            </select>
											</div>
									...
									<div class="panel-footer">
										<button type="submit" name="submit" class="btn btn-primary btn-lg btn-block">Update User</button>
									</div>
									</form>
									</div>
									<?php
...
if (isset($_REQUEST['submit'])) //here give the name of your button on which you would like    //to perform action.
{
	...
	{
		if($kode == '40min.'){
				$sql= "UPDATE USER_ID SET PASSWORD=:PASSWORD, GRUP_ID=:GRUP_ID, NAMA=:FULLNAME WHERE USERNAME = :USERNAME";
		...
		ECHO "<div class='row'>
                <div class='col-lg-12'>
                    <div class='panel panel-primary'>
                        <div class='panel-heading'>
                            <i class='fa fa-user fa-fw'></i> UPDATE NEW USER
                        </div>
                        <!-- /.panel-heading -->
                        <div class='panel-body'>";
						echo "<div class='alert alert-info alert-dismissable'>
								<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
                                Selamat, User Baru Berhasil Di Ubah <a href='#' class='alert-link'>Informasi !</a>.
                            </div>";
						echo"</div>
				</div>
			</div>
