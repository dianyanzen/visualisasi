                ...
                <div class="col-lg-12">
                   <div class="panel-body">
                            ...
                            <ul class="nav nav-pills">
                                ...
                                <li class="active"><a href="tbdkawin.php">Perkawinan</a>
                                </li>
                                    ...
                                    <div class="col-lg-12">
										<div class="panel panel-primary">
											<div class="panel-heading">
												Tabel Statistik Pendaftaran Penduduk WNI Kota Bandung - Akta Perkawinan
											</div>
										<div class="panel-body" >
										
										<form method="post" name="formstable" id="formstable" action="tbdkawin.php" role="form">
...
if($_REQUEST['statistik']=="1"){
	...
	$sql= "SELECT * FROM T5_KWN_AGAMA WHERE BLN >= TO_DATE('".$BULAN."','/MM/yyyy') AND BLN < TO_DATE('".$BULAN."','MM/yyyy') +1 ";
		$stmt = oci_parse($conn, $sql);
		oci_execute($stmt);
	...
	ECHO "<div class='row'>
                <div class='col-lg-12'>
                    <div class='panel panel-default'>
                        <div class='panel-heading'>
                            <i class='fa fa-table fa-fw'></i> TABEL PERKAWINAN MENURUT AGAMA KOTA BANDUNG
                        </div>
                        <!-- /.panel-heading -->
                        <div class='panel-body'>
                            <table width='100%' class='table table-striped table-bordered table-hover' id='dataTables-example'>
                                ...
                                <tbody>";
									...
									$sql= "SELECT SUM(ISLAM) AS P1, SUM(KRISTEN) AS P2,SUM(KATHOLIK) AS P3,SUM(HINDU) AS P4,SUM(BUDHA) AS P5,SUM(KONGHUCU) AS P6,SUM(KEPERCAYAAN) AS P7,SUM(ISLAM)+SUM(KRISTEN)+SUM(KATHOLIK)+SUM(HINDU)+SUM(BUDHA)+SUM(KONGHUCU)+SUM(KEPERCAYAAN) AS P8 FROM T5_KWN_AGAMA WHERE NO_PROP='32' AND NO_KAB ='73' and BLN  >= TO_DATE('".$BULAN."','MM/yyyy') AND BLN < TO_DATE('".$BULAN."','MM/yyyy')+1";
									$stmt = oci_parse($conn, $sql);
									oci_execute($stmt);
									while (($row = oci_fetch_array($stmt,OCI_ASSOC)) != false) {
