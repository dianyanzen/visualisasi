...
$pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, PDF_HEADER_TITLE.' Kepala Keluarga Kecamatan '.$KECAMATAN.', Kelurahan '.$KELURAHAN.'', 'RW  00'.$NORW.', RT 00'.$NORT.' '.PDF_HEADER_STRING);
...
$tbl_header = '<table width="100%" border="1" align="center">
                                <thead>
                                    <tr>
										...
										<th bgcolor="#337ab7" color="white" width="20%"><span style="font-weight: bold;">No KK</span></th>
										<th bgcolor="#337ab7" color="white" width="33%"><span style="font-weight: bold;">Kepala Keluarga</span></th>
...
$tbl ='';
$urt = 0;
 $sql= "SELECT TO_CHAR(B.NO_RW,'000') AS P1, TO_CHAR(B.NO_RT,'000') AS P2, A.NO_KK AS P3, B.NAMA_KEP AS P4, 
...
A.NO_PROP=32 AND A.NO_KAB=73 AND A.NO_KEC = ".$NOKEC." AND A.NO_KEL =".$NOKEL." AND B.NO_RW = ".$NORW." AND B.NO_RT =".$NORT." AND  A.STAT_HBKEL = 1 AND 
