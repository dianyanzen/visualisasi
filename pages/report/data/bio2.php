...
$pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, PDF_HEADER_TITLE.' Penduduk Kecamatan '.$KECAMATAN.', Kelurahan '.$KELURAHAN.', Usia '.$SORT.' Tahun', PDF_HEADER_STRING);
