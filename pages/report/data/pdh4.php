...
$pdf->SetTitle('Statistik Surat Pindah Keluar '.$NOKEC.'-'.$NOKEL);
...
$pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, PDF_HEADER_TITLE.' Surat Pindah Keluar Kecamatan '.$KECAMATAN.', Kelurahan '.$KELURAHAN.'', PDF_HEADER_STRING);
