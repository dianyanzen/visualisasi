...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Daftar Entri Biodata Baru<br>
					<?php
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-table fa-fw"></i> Biodata
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
									...
									$nowdate = date("d/m/Y");
									$sql= "SELECT BIODATA_WNI.NIK, BIODATA_WNI.NAMA_LGKP, BIODATA_WNI.TGL_ENTRI, BIODATA_WNI.NAMA_PET_ENTRI, SETUP_KEL.NAMA_KEL FROM BIODATA_WNI INNER JOIN SETUP_KEL ON BIODATA_WNI.NO_PROP = SETUP_KEL.NO_PROP AND BIODATA_WNI.NO_KAB = SETUP_KEL.NO_KAB AND BIODATA_WNI.NO_KEC = SETUP_KEL.NO_KEC AND BIODATA_WNI.NO_KEL = SETUP_KEL.NO_KEL WHERE TGL_ENTRI >= TO_DATE('".$nowdate."','dd/MM/yyyy') AND TGL_ENTRI < TO_DATE('".$nowdate."','dd/MM/yyyy') +1";
                                    ...
                                    echo "<td>".htmlentities($row['TGL_ENTRI'])."</td>";
                                    echo "<td class='center'>".htmlentities($row['NAMA_PET_ENTRI'])."</td>";
