...
<!-- Navigation -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Daftar Cetak KTP-EL<br>
					<?php
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-table fa-fw"></i> Pencetakan KTP-EL
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
									...
									$nowdate = date("d/m/Y");
									$sql= "SELECT A.NIK, B.NAMA_LGKP, B.NAMA_KEC, B.NAMA_KEL, B.CURRENT_STATUS_CODE FROM CARD_MANAGEMENT@DBL2 A INNER JOIN DEMOGRAPHICS_ALL_X B ON A.NIK = B.NIK WHERE B.NAMA_KAB = 'KOTA BANDUNG' AND A.CREATED >= TO_DATE('".$nowdate."','dd/MM/yyyy') AND A.CREATED < TO_DATE('".$nowdate."','dd/MM/yyyy') +1";
                                    ...
                                    echo "<td>".htmlentities($row['NAMA_KEL'])."</td>";
                                    echo "<td class='center'>".htmlentities($row['CURRENT_STATUS_CODE'])."</td>";
                                    echo "</tr>";
									}
									?>
								</tbody>
