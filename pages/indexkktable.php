            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
						...
						<li>
                            <a href="#"><i class="fa fa-table fa-fw"></i> Cakupan Kartu Keluarga<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
                                <li>
                                    <a href="cakkktah.php">Tahunan</a>
                                </li>
                                <li>
                                    <a href="cakkkbul.php">Bulanan</a>
                                </li>
                                <li>
                                    <a href="cakkkhar.php">Harian</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
