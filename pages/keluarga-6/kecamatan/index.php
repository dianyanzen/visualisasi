                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <i class="fa fa-table fa-fw"></i> Kepala Keluarga Menurut Penyandang Cacat
                        </div>
                        <!-- /.panel-heading -->
                        <div class='panel-body'>
                            <table width='100%' class='table table-striped table-bordered table-hover' id='dataTables-example'>
                                ...
                                <tbody>
									<?PHP
									Include('../../../config/connect222.php');
									$sql= "SELECT  a.NO_KEL as P1, a.NAMA_KEL AS P2, SUM(b.FISIK) AS P3,SUM(b.NETRA) AS P4,SUM(b.RUNGU) AS P5,SUM(b.MENTAL) AS P6,SUM(b.FISIK_MENTAL) AS P7,SUM(b.LAINNYA) AS P8,SUM(b.FISIK) +SUM(b.NETRA) +SUM(b.RUNGU) +SUM(b.MENTAL) +SUM(b.FISIK_MENTAL)+SUM(b.LAINNYA) AS P9 
									...
									echo "<td class='center'><a href='../../keluarga-6/kecamatan/kelurahan/index.php?NOKEL=".htmlentities($row['P1'])."'><i class='fa fa-paw  fa-fw'></i> Detail</a></td>";
                                    echo "</tr>";
