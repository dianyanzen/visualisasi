...
<!-- Navigation -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Daftar Perekaman KTP-EL<br>
					<?php
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-table fa-fw"></i> Perekaman KTP-EL
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
									...
									$nowdate = date("d/m/Y");
									$sql= "SELECT NIK, NAMA_LGKP, NAMA_KEC, NAMA_KEL, CURRENT_STATUS_CODE FROM DEMOGRAPHICS_ALL_X  WHERE CURRENT_STATUS_CODE NOT LIKE 'CARD%' AND NAMA_KAB = 'KOTA BANDUNG' AND CREATED >= TO_DATE('".$nowdate."','dd/MM/yyyy') AND CREATED < TO_DATE('".$nowdate."','dd/MM/yyyy') +1";
