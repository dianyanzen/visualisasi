        ...
        <div id="page-wrapper">
            <div class="row">
				...
				Include('../../../config/connect222.php');
                    ...
                    ECHO "<h1 class='page-header'>DATA KEPEMILIKAN AKTA KECAMATAN ".$row['NAMA_KEC']." MENURUT UMUR ".$row2['P1']."<br>";
					?>
					<?php
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <i class="fa fa-table fa-fw"></i> Penduduk Menurut Kepemilikan Akta Seluruhnya
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <table width='100%' class='table table-striped table-bordered table-hover' id='dataTables-example'>
                                ...
                                <tbody>
									...
									echo "<td class='center'><a href='../../biodata-11/kecamatan/kelurahan/index.php?NOKEL=".htmlentities($row['P1'])."&SORT=".$SORT."'><i class='fa fa-paw  fa-fw'></i> Detail</a></td>";
                                    echo "</tr>";
									}
