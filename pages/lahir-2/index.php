        ...
        <div id="page-wrapper">
            <div class="row">
				...
				Include('../../config/connect222.php');
                    ...
                    ECHO "<h1 class='page-header'>DATA KEPEMILIKAN AKTA MENURUT UMUR ".$row['P1']."<br>";
					?>
					<?php
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <i class="fa fa-table fa-fw"></i> Tabel Penduduk Menurut Kepemilikan Akta Seluruhnya
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <table width='100%' class='table table-striped table-bordered table-hover' id='dataTables-example'>
                                ...
                                <tbody>
									<?PHP
									Include('../../config/connect222.php');
									$sql= "SELECT a.NO_KEC as P1, a.NAMA_KEC AS P2,  SUM(ADA_AKTA) AS P3, SUM(TIDAK_ADA_AKTA) AS P4, SUM(ADA_AKTA)+SUM(TIDAK_ADA_AKTA) AS P5
									FROM SETUP_KEC a INNER JOIN T5_STT_STRUKTUR_UMUR b
									ON a.NO_KEC=b.NO_KEC  WHERE a.NO_PROP='32' AND a.NO_KAB ='73' and b.SORT = '".$SORT."' and b.BLN  >= TO_DATE('$BULAN','MM/yyyy') AND b.BLN < TO_DATE('$BULAN','MM/yyyy')+1
									GROUP BY a.NO_KEC, a.NAMA_KEC, b.sort ORDER BY a.NO_KEC";
									$stmt = oci_parse($conn, $sql);
									oci_execute($stmt);
									...
									echo "<td class='center'><a href='../biodata-11/kecamatan/index.php?NOKEC=".htmlentities($row['P1'])."'><i class='fa fa-paw  fa-fw'></i> Detail</a></td>";
                                    echo "</tr>";
									}
