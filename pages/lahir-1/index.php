        ...
        <div id="page-wrapper">
            <div class="row">
				...
				Include('../../../admin/config/connect222.php');
                    ...
                    ECHO "<h1 class='page-header'>DATA KEPEMILIKAN AKTA MENURUT UMUR 0-18 TAHUN<br>";
					?>
					<?php
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <i class="fa fa-table fa-fw"></i> Tabel Penduduk Menurut Kepemilikan Akta 0-18 Tahun
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <table width='100%' class='table table-striped table-bordered table-hover' id='dataTables-example'>
                                ...
                                <tbody>
									<?PHP
									Include('../../../admin/config/connect222.php');
									$sql= "SELECT a.NO_KEC as P1, a.NAMA_KEC AS P2, SUM(b.ADA_AKTA) AS P4, SUM(b.TIDAK_ADA_AKTA) AS P5, SUM(b.ADA_AKTA)+SUM(b.TIDAK_ADA_AKTA) AS P6
									FROM SETUP_KEC a INNER JOIN T5_STT_AKTA18 b
									...
									echo "<td class='center'><a href='../lahir-1/kecamatan/index.php?NOKEC=".htmlentities($row['P1'])."'><i class='fa fa-paw  fa-fw'></i> Detail</a></td>";
                                    echo "</tr>";
									}
