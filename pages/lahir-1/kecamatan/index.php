    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
				...
				//ECHO $NOKEC;
				//ECHO $BULAN;
				Include('../../../../admin/config/connect222.php');
                    ...
                    ECHO "<h1 class='page-header'>DATA KEPEMILIKAN AKTA KECAMATAN ".$row['NAMA_KEC']." MENURUT UMUR 0-18 TAHUN<br>";
					?>
					<?php
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <i class="fa fa-table fa-fw"></i> Penduduk Menurut Kepemilikan Akta 0-18 Tahun
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <table width='100%' class='table table-striped table-bordered table-hover' id='dataTables-example'>
                                ...
                                <tbody>
									<?PHP
									Include('../../../../admin/config/connect222.php');
									$sql= "SELECT a.NO_KEL as P1, a.NAMA_KEL AS P2, SUM(b.ADA_AKTA) AS P4, SUM(b.TIDAK_ADA_AKTA) AS P5, SUM(b.ADA_AKTA)+SUM(b.TIDAK_ADA_AKTA) AS P6
									FROM SETUP_KEL a INNER JOIN T5_STT_AKTA18 b
									ON a.NO_KEL=b.NO_KEL  WHERE a.NO_PROP='32' AND a.NO_KAB ='73' AND A.NO_KEC ='".$NOKEC."' and b.BLN  >= TO_DATE('".$BULAN."','MM/yyyy') AND b.BLN < TO_DATE('".$BULAN."','MM/yyyy')+1
									GROUP BY a.NO_KEL, a.NAMA_KEL ORDER BY a.NO_KEL";
									$stmt = oci_parse($conn, $sql);
									oci_execute($stmt);
									...
									echo "<td class='center'><a href='../../lahir-1/kecamatan/kelurahan/index.php?NOKEL=".htmlentities($row['P1'])."'><i class='fa fa-paw  fa-fw'></i> Detail</a></td>";
                                    echo "</tr>";
									}
