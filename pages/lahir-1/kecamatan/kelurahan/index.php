        ...
        <div id="page-wrapper">
            <div class="row">
				...
				Include('../../../../../admin/config/connect222.php');
                    ...
                    ECHO "<h1 class='page-header'>DATA KEPEMILIKAN AKTA KELURAHAN ".$row['NAMA_KEL']." MENURUT UMUR 0-18 TAHUN<br>";
					?>
					<?php
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <i class="fa fa-table fa-fw"></i> Penduduk Menurut Kepemilikan Akta
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <table width='100%' class='table table-striped table-bordered table-hover' id='dataTables-example'>
                                ...
                                <tbody>
									<?PHP
									Include('../../../../../admin/config/connect222.php');
									$sql= "SELECT a.NO_KEL as P1, a.NAMA_KEL AS P2, SUM(b.ADA_AKTA) AS P3, SUM(b.TIDAK_ADA_AKTA) AS P4, SUM(b.ADA_AKTA)+SUM(b.TIDAK_ADA_AKTA) AS P5
									FROM SETUP_KEL a INNER JOIN T5_STT_AKTA18 b
									ON a.NO_KEL=b.NO_KEL  WHERE a.NO_PROP='32' AND a.NO_KAB ='73' AND A.NO_KEC ='".$NOKEC."' AND A.NO_KEL ='".$NOKEL."' and b.BLN  >= TO_DATE('".$BULAN."','MM/yyyy') AND b.BLN < TO_DATE('".$BULAN."','MM/yyyy')+1
