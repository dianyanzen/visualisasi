...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Daftar Entri Akta Kawin<br>
					<?php
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-table fa-fw"></i> Akta Perkawinan
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
									...
									$nowdate = date("d/m/Y");
									$sql= "SELECT KAWIN_NO, SUAMI_NAMA_LGKP, ISTRI_NAMA_LGKP, KAWIN_TGL_KAWIN, KAWIN_TGL_LAPOR FROM CAPIL_KAWIN WHERE KAWIN_TGL_LAPOR >= TO_DATE('".$nowdate."','dd/MM/yyyy') AND KAWIN_TGL_LAPOR < TO_DATE('".$nowdate."','dd/MM/yyyy') +1";
									$stmt = oci_parse($conn, $sql);
									oci_execute($stmt);
									while (($row = oci_fetch_array($stmt, OCI_ASSOC)) != false) {
                                    echo "<tr class='gradeA'>";
                                    echo "<td>".htmlentities($row['KAWIN_NO'])."</td>";
                                    echo "<td>".htmlentities($row['SUAMI_NAMA_LGKP'])."</td>";
                                    echo "<td>".htmlentities($row['ISTRI_NAMA_LGKP'])."</td>";
                                    echo "<td class='center'>".htmlentities($row['KAWIN_TGL_KAWIN'])."</td>";
                                    echo "<td class='center'>".htmlentities($row['KAWIN_TGL_LAPOR'])."</td>";
                                    echo "</tr>";
									}
									?>
								</tbody>
