        ...
        <div id="page-wrapper">
            <div class="row">
				...
				Include('../../../../config/connect222.php');
					...
					$sql2= "SELECT KODE_PEKERJAAN AS P3,
...
SUM(VALUE) AS P2 FROM T5_STT_PEKERJAAN  WHERE NO_PROP='32' AND NO_KAB ='73' AND KODE_PEKERJAAN='".$PKRJN."' AND BLN  >= TO_DATE('".$BULAN."','MM/yyyy') AND BLN < TO_DATE('".$BULAN."','MM/yyyy')+1 GROUP BY KODE_PEKERJAAN ORDER BY KODE_PEKERJAAN";
					...
					//echo "text: 'DIAGRAM KOLOM PENDUDUK MENURUT GOLONGAN DARAH KECAMATAN ".$row['NAMA_KEL']."'";
					
                    ECHO "<h1 class='page-header'>DATA PENDUDUK KELURAHAN ".$row['NAMA_KEL']." - Menurut Pekerjaan ".$row2['P1']."<br>";
					?>
					<?php
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <i class="fa fa-table fa-fw"></i> Penduduk Menurut Jenis Pekerjaan <?php echo $row2['P1']; ?>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <table width='100%' class='table table-striped table-bordered table-hover' id='dataTables-example'>
								...
								<!--
                                    <tr>
										<td colspan='5' align='center'> <div align ='center'><b>PENDUDUK Berdasarkan Jenis Kelamin</b></div></td>
										</tr> -->
									<tr>
                                ...
                                <tbody>
									...
									ON a.NO_KEC=b.NO_KEC and a.NO_KEL=b.NO_KEL  WHERE a.NO_PROP='32' AND a.NO_KAB ='73' AND a.NO_KEC ='".$NOKEC."' AND a.NO_KEL='".$NOKEL."' AND b.KODE_PEKERJAAN ='".$PKRJN."' and b.BLN  >= TO_DATE('".$BULAN."','MM/yyyy') AND b.BLN < TO_DATE('".$BULAN."','MM/yyyy')+1
									...
									//echo "<td class='center' align='center'><a target='_blank' href='kelurahan/index.php?NOKEL=".htmlentities($row['P1'])."'><i class='fa fa-paw  fa-fw' id=></i> Detail</a></td>";
