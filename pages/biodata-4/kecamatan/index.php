...
SUM(VALUE) AS P2 FROM T5_STT_PEKERJAAN  WHERE NO_PROP='32' AND NO_KAB ='73' AND KODE_PEKERJAAN='".$PKRJN."' AND BLN  >= TO_DATE('".$BULAN."','MM/yyyy') AND BLN < TO_DATE('".$BULAN."','MM/yyyy')+1 GROUP BY KODE_PEKERJAAN ORDER BY KODE_PEKERJAAN";
                    ...
                    ECHO "<h1 class='page-header'>DATA PENDUDUK KECAMATAN ".$row['NAMA_KEC']." - Menurut Pekerjaan ".$row2['P1']."<br>";
					?>
					<?php
                        ...
                        <div class="panel-body">
                            <table width='100%' class='table table-striped table-bordered table-hover' id='dataTables-example'>
                                ...
                                <tbody>
									...
									ON a.NO_KEC=b.NO_KEC and a.NO_KEL=b.NO_KEL  WHERE a.NO_PROP='32' AND a.NO_KAB ='73' AND a.NO_KEC ='".$NOKEC."' AND b.KODE_PEKERJAAN ='".$PKRJN."' and b.BLN  >= TO_DATE('".$BULAN."','MM/yyyy') AND b.BLN < TO_DATE('".$BULAN."','MM/yyyy')+1
