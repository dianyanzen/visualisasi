        ...
        <div id="page-wrapper">
            <div class="row">
				...
				Include('../../../../config/connect222.php');
                    ...
                    ECHO "<h1 class='page-header'>DATA PENDUDUK KELURAHAN ".$row['NAMA_KEL']." MENURUT UMUR ".$row2['P1']."<br>";
					?>
					<?php
                        ...
                        <div class="panel-body">
                            <table width='100%' class='table table-striped table-bordered table-hover' id='dataTables-example'>
                                ...
                                <tbody>
									...
									ON a.NO_KEC=b.NO_KEC and a.NO_KEL=b.NO_KEL  WHERE a.NO_PROP='32' AND a.NO_KAB ='73' AND a.NO_KEC ='".$NOKEC."' and a.NO_KEL ='".$NOKEL."' and sort='".$SORT."' and b.BLN  >= TO_DATE('".$BULAN."','MM/yyyy') AND b.BLN < TO_DATE('".$BULAN."','MM/yyyy')+1
