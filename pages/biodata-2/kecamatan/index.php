        ...
        <div id="page-wrapper">
            <div class="row">
				...
				Include('../../../config/connect222.php');
                    ...
                    ECHO "<h1 class='page-header'>DATA PENDUDUK KECAMATAN ".$row['NAMA_KEC']." MENURUT UMUR ".$row2['P1']."<br>";
					?>
					<?php
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <i class="fa fa-table fa-fw"></i> Penduduk Menurut Struktur Umur
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <table width='100%' class='table table-striped table-bordered table-hover' id='dataTables-example'>
                                ...
                                <tbody>
									<?PHP
									Include('../../../config/connect222.php');
									$sql= "SELECT a.NO_KEC as P10, a.NO_KEL as P1, a.NAMA_KEL AS P2, b.SORT as P3, SUM(b.LAKI_LAKI) AS P4, SUM(b.PEREMPUAN) AS P5, SUM(b.LAKI_LAKI)+SUM(b.PEREMPUAN) AS P6
									FROM SETUP_KEL a INNER JOIN T5_STT_STRUKTUR_UMUR b
									ON a.NO_KEC=b.NO_KEC and a.NO_KEL=b.NO_KEL  WHERE a.NO_PROP='32' AND a.NO_KAB ='73' AND a.NO_KEC ='".$NOKEC."' and sort='".$SORT."' and b.BLN  >= TO_DATE('".$BULAN."','MM/yyyy') AND b.BLN < TO_DATE('".$BULAN."','MM/yyyy')+1
									GROUP BY a.NO_KEC, a.NO_KEL, a.NAMA_KEL, b.SORT ORDER BY a.NO_KEL";
									$stmt = oci_parse($conn, $sql);
									oci_execute($stmt);
									...
									echo "<td class='center'><a href='../../biodata-2/kecamatan/kelurahan/index.php?NOKEL=".htmlentities($row['P1'])."&SORT=".$SORT."'><i class='fa fa-paw  fa-fw'></i> Detail</a></td>";
                                    echo "</tr>";
									}
