        ...
        <div id="page-wrapper">
            <div class="row">
				...
				Include('../../config/connect222.php');
                    ...
                    ECHO "<h1 class='page-header'>DATA PENDUDUK MENURUT UMUR ".$row['P1']."<br>";
					?>
					<?php
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <i class="fa fa-table fa-fw"></i> Tabel Penduduk Menurut Struktur Umur
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <table width='100%' class='table table-striped table-bordered table-hover' id='dataTables-example'>
                                ...
                                <tbody>
									<?PHP
									Include('../../config/connect222.php');
									$sql= "SELECT a.NO_KEC as P1, a.NAMA_KEC AS P2, SUM(b.LAKI_LAKI) AS P4, SUM(b.PEREMPUAN) AS P5, SUM(b.LAKI_LAKI)+SUM(b.PEREMPUAN) AS P6
									...
									echo "<td class='center'><a href='../biodata-2/kecamatan/index.php?NOKEC=".htmlentities($row['P1'])."'><i class='fa fa-paw  fa-fw'></i> Detail</a></td>";
                                    echo "</tr>";
									}
