...
<!-- Navigation -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Daftar Entri Akta Mati<br>
					<?php
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-table fa-fw"></i> Akta Kematian
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
									...
									$nowdate = date("d/m/Y");
									$sql= "SELECT CAPIL_MATI.MATI_NO, CAPIL_MATI.MATI_NAMA_LGKP, CAPIL_MATI.MATI_TGL_MATI, A5_MASTER_KELAMIN.DESCRIP, CAPIL_MATI.PLPR_TGL_LAPOR FROM CAPIL_MATI INNER JOIN A5_MASTER_KELAMIN ON CAPIL_MATI.MATI_JNS_KELAMIN = A5_MASTER_KELAMIN.NO WHERE PLPR_TGL_LAPOR >= TO_DATE('".$nowdate."','dd/MM/yyyy') AND PLPR_TGL_LAPOR < TO_DATE('".$nowdate."','dd/MM/yyyy') +1";
									$stmt = oci_parse($conn, $sql);
									oci_execute($stmt);
									while (($row = oci_fetch_array($stmt, OCI_ASSOC)) != false) {
                                    echo "<tr class='gradeA'>";
                                    echo "<td>".htmlentities($row['MATI_NO'])."</td>";
                                    echo "<td>".htmlentities($row['MATI_NAMA_LGKP'])."</td>";
                                    echo "<td>".htmlentities($row['MATI_TGL_MATI'])."</td>";
