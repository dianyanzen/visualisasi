        ...
        <div id="page-wrapper">
            <div class="row">
				...
				Include('../../../../config/connect222.php');
					...
					//echo "text: 'DIAGRAM KOLOM KEPINDAHAN MENURUT GOLONGAN DARAH KECAMATAN ".$row['NAMA_KEL']."'";
					
                    ECHO "<h1 class='page-header'>DATA KEPINDAHAN KELURAHAN ".$row['NAMA_KEL']."<br>";
					?>
					<?php
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <i class="fa fa-table fa-fw"></i> Kedatangan Anggota Menurut Klasifikasi Kepindahan
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <table width='100%' class='table table-striped table-bordered table-hover' id='dataTables-example'>
								...
								<!--
                                    <tr>
										<td colspan='5' align='center'> <div align ='center'><b>KEPINDAHAN Berdasarkan Jenis Kelamin</b></div></td>
										</tr> -->
									<tr>
                                        <th>Nomor</th>
