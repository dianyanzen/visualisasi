                ...
                <div class="col-lg-12">
                   <div class="panel-body">
                            ...
                            <ul class="nav nav-pills">
								...
								<li><h1> System Disduk Hapus User</h1></li>
                            </ul>
                            ...
                            <div class="tab-content">
								...
								<br>
                                    <div class="col-lg-12">
										<div class="panel panel-primary">
											<div class="panel-heading">
												Sistem Information Administrator - Hapus User
											</div>
										<div class="panel-body" >
										
										<form method="post" name="formstatistik" id="formstatistik" action="userdelete.php" role="form">
									...
									<div class="panel-footer">
										<button type="submit" name="submit" class="btn btn-primary btn-lg btn-block">Delete User</button>
									</div>
									</form>
									</div>
									<?php
...
if (isset($_REQUEST['submit'])) //here give the name of your button on which you would like    //to perform action.
{
	...
	{
		if($kode == '40min.'){
				$sql= "DELETE FROM USER_ID WHERE USERNAME = :USERNAME";
