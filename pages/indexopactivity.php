            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
						...
						<li>
                            <a href="loginAbsensi.php"><i class="fa fa-desktop fa-fw"></i> Absensi Pendamping Operator</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
						...
						<div class="panel-footer">
										 <a href="indexoperator.php" class="btn btn-primary btn-lg btn-block">Kembali</a>
						</div>
				</div>
			</div>
        </div>
