...
function initialize(){
    ...
    var map;
    //lat lng
    myLatlng = new google.maps.LatLng(-6.908893, 107.613837);
	//https://maps.google.com/maps?ll=-6.908628,107.613537&z=19&hl=en-US&gl=US&mapclient=apiv3&cid=16204084358779977706
	//https://maps.google.com/maps?ll=-6.908743,107.613807&z=20&hl=en-US&gl=US&mapclient=apiv3&cid=16204084358779977706
    //define style
    var styles = [
        {
            //set all color
    ...
    var marker = new google.maps.Marker({
        position: myLatlng,
        map: map,
        title: 'Dinas Kependudukan Dan Pencatatan Sipil, Kota Bandung'
    });
}
