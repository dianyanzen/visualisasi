...
var App = function () {
    ...
    var handleSidebarMenu = function () {
        ...
        jQuery('.page-content , .header').on('click', '.ajaxify', function (e) {
            e.preventDefault();
            App.scrollTop();

            var url = $(this).attr("href");			
            var pageContent = $('.page-content');
			var pageContentBody=$('#'+$(this).data("target"));
            //var pageContentBody = $('.page-content .page-content-body');
            var hidden="";
            if($(this).data('hidden')){
        ...
        jQuery(document).on('click', '.kembali', function (e) {
            e.preventDefault();
            App.blockUI({boxed: true,message: 'Harap Tunggu'});
        ...
        jQuery('.page-content').on('click', '.hapus', function (e) {
            e.preventDefault();
            var refresh=$(this).data('refresh');
            var url=$(this).attr('href');
            var pesan=$(this).data('msg');
            dialog_confirm=bootbox.confirm({
                            ...
                            message: '<div class="row">'+
                                        '<div class="col-md-12">'+
                                            ...
                                            '</div>'+
                                            '<div class="col-md-10"><ul class="text-warning no-bullets"><label><li>'+pesan+'</li></label></ul></div>'+
                                        '</div>'+
                                    '</div>',
                            buttons: {                      
                                'confirm': {
                                                    ...
                                                    dialog_alert=bootbox.alert({
                                                        ...
                                                        message: '<div class="row">'+
                                                                    '<div class="col-md-12">'+
                                                                        ...
                                                                        '</div>'+
                                                                        '<div class="col-md-10"><ul class="text-success no-bullets"><label><li>'+json.pesan+'</li></label></ul></div>'+
                                                                    '</div>'+
                                                                '</div>',
                                                        buttons: {                                              
                                                            'ok': {
                                                    ...
                                                    dialog_alert=bootbox.alert({
                                                        ...
                                                        message: '<div class="row">'+
                                                                    '<div class="col-md-12">'+
                                                                        ...
                                                                        '</div>'+
                                                                        '<div class="col-md-10"><ul class="text-danger no-bullets"><label class="error"><li>'+json.pesan+'</li></label></ul></div>'+
                                                                    '</div>'+
                                                                '</div>',
                                                        buttons: {                                              
                                                            'ok': {
            ...
            dialog_confirm.find('.modal-body').addClass('alert-warning');
		...
		jQuery('.page-content').on('click','ul.dropdown-menu [data-toggle=dropdown]',function(event) {		
    ...
    return {
        ...
        initAjax: function () {
            ...
            $('select.readonly').select_readonly();            
        },
        ...
        blockUI: function (options) {
            ...
            var html = '';
            if (options.iconOnly) {
                html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '')+'"><img style="" src="'+(options.image ? options.image : 'bootstrap/v5/assets/img/loading-spinner-grey.gif')+'" align=""></div>';
            } else if (options.textOnly) {
                html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '')+'"><span>&nbsp;&nbsp;' + (options.message ? options.message : 'LOADING...') + '</span></div>';
            } else {    
                html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '')+'"><img style="" src="'+(options.image ? options.image : 'bootstrap/v5/assets/img/loading-spinner-grey.gif')+'" align=""><span>&nbsp;&nbsp;' + (options.message ? options.message : 'LOADING...') + '</span></div>';
            }
...
function CharYearServer(tgl_cek,tgl_now) {
    var re=/^\d{1,2}-\d{1,2}-\d{4}$/;    
    if(re.test(tgl_cek)){
        var array_tgl_now=tgl_now.split('-');
        var yearNow=parseInt(array_tgl_now[2]);
        var monthNow=parseInt(array_tgl_now[1]);
        var dayNow=parseInt(array_tgl_now[0]);
        var array_tgl_cek=tgl_cek.split('-');
        var yearDob=parseInt(array_tgl_cek[2]);
        var monthDob=parseInt(array_tgl_cek[1]);
        var dayDob=parseInt(array_tgl_cek[0]);
        if (yearNow < 100) {
